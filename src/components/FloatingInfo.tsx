...
export default function FloatingInfo({ scrollYProgress }: FloatingInfoProps) {
  ...
  return (
    <div className="relative w-full h-full pointer-events-none select-none flex items-center justify-center">
      {/* Milestone 01: 10+ Years of Experience */}
      <motion.div
      ...
      >
        <div className="flex items-center gap-2 font-mono text-xs text-red-500 font-bold tracking-widest uppercase mb-2">
          ...
          <span className={isDark ? "text-white/40" : "text-black/40"}>• EST. 2016</span>
        </div>

        <div
          className={`font-space-grotesk text-7xl sm:text-9xl md:text-[11rem] font-black tracking-tighter leading-[0.85] transition-colors duration-300 ${
            isDark
              ? "text-white [text-shadow:_0_0_60px_rgba(255,255,255,0.35),_0_10px_35px_rgba(0,0,0,0.8)]"
              : "text-black [text-shadow:_0_10px_35px_rgb(0_0_0_/_20%)]"
          }`}
        >
        ...
        <h3
          className={`font-space-grotesk text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mt-3 transition-colors duration-300 ${
            isDark
              ? "text-white [text-shadow:_0_0_20px_rgba(255,255,255,0.2)]"
              : "text-black [text-shadow:_0_5px_15px_rgb(0_0_0_/_15%)]"
          }`}
        >
        ...
        <p
          className={`font-sans text-sm sm:text-base md:text-lg font-medium leading-relaxed mt-2 max-w-md transition-colors duration-300 ${
            isDark
              ? "text-white/80 [text-shadow:_0_2px_15px_rgba(0,0,0,0.9)]"
              : "text-black/85 [text-shadow:_0_2px_10px_rgb(0_0_0_/_15%)]"
          }`}
        >
      ...
      {/* Milestone 02: 100+ Projects Completed */}
      <motion.div
      ...
      >
        <div className="flex items-center justify-end gap-2 font-mono text-xs text-red-500 font-bold tracking-widest uppercase mb-2">
          <span className={isDark ? "text-white/40" : "text-black/40"}>WORLDWIDE DELIVERY •</span>
        ...
        <p
          className={`font-sans text-sm sm:text-base md:text-lg font-medium leading-relaxed mt-2 max-w-md ml-auto transition-colors duration-300 ${
            isDark
              ? "text-white/80 [text-shadow:_0_2px_15px_rgba(0,0,0,0.9)]"
              : "text-black/85 [text-shadow:_0_2px_10px_rgb(0_0_0_/_15%)]"
          }`}
